...
set(LAPACK_LIBRARIES $ENV{OLCF_OPENBLAS_ROOT}/lib/libopenblas.so;$ENV{OLCF_OPENBLAS_ROOT}/lib/libopenblas_power9p-r0.3.6.so;$ENV{OLCF_NETLIB_LAPACK_ROOT}/lib64/liblapack.so CACHE FILEPATH "Libraries to link against to use LAPACK.")
