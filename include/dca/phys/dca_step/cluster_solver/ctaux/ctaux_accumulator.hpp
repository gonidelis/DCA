...
public:
  ...
  void measure(const int meas_id);
...
private:
  ...
  void accumulate_two_particle_quantities(const int meas_id);
...
template <dca::linalg::DeviceType device_t, class Parameters, class Data, typename Real>
void CtauxAccumulator<device_t, Parameters, Data, Real>::measure(const int meas_id) {
...
template <dca::linalg::DeviceType device_t, class Parameters, class Data, typename Real>
void CtauxAccumulator<device_t, Parameters, Data, Real>::accumulate_two_particle_quantities(const int meas_id) {
