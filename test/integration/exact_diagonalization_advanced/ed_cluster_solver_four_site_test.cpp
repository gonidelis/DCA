...
//
// This file tests the exact diagonalization (ED) solver on a four-site square-lattice Hubbard model
// and compares the free Green's functions, G_0(\vec{k}, i\omega) and G_0(\vec{k}, \tau), against
// their analytic result.
...
TEST(EDClusterSolverFourSiteTest, ComputeG0) {
  ...
  params.read_input_and_broadcast<dca::io::JSONReader>(
      DCA_SOURCE_DIR "/test/integration/exact_diagonalization_advanced/four_site_input.json");
  params.update_model();
